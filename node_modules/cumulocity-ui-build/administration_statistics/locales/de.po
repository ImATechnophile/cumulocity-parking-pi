...
msgstr[0] "1 API-Anforderung insgesamt"
msgstr[1] "{{requestCount}} API-Anforderungen insgesamt"
...
msgstr[0] "1 Geräte-API-Anforderung"
msgstr[1] "{{deviceRequestCount}} Geräte-API-Anfragen"
...
msgstr "Anzahl der Geräte an {{end}}, einschließlich Kindgeräte"
...
msgstr "API-Anforderungen werden berechnet"

msgid "calculating number of device API requests"
msgstr "API-Anforderungen von Geräten werden berechnet"
